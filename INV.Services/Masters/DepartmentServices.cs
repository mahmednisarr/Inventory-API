...
namespace INV.Services.Masters
{
    public class DepartmentServices : IDepartmentServices
    {
        ...
        public DepartmentServices(IConfiguration config, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<TResponse> DeleteDepartment(int ID, int usrID)
        {
            try
            {
                _list.Add(new ViewParam() { Name = "userID", Value = usrID });
                _list.Add(new ViewParam() { Name = "id", Value = ID });
                DataSet _dataSet = await _dataWare.GetDataSet("I_Department_Delete", _list);
        ...
        public async Task<TResponse> GetAllDepartments(int LocID)
        {

            var oo = _httpContextAccessor.HttpContext.Request.Headers["CompName"].ToString();
            try
            {
        ...
        public async Task<TResponse> SaveOrUpdateDepartment(DepartmentDto reqResponseDto, int usrID, int LocID)
        {
            try
            {
